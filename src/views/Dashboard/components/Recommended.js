...
const Recommended = () => {
  ...
  const recommendedUsers = useSelector(
    state => state.recommendedUserReducer.recommendedUsers
  );
  ...
  const loading = useSelector(state => state.recommendedUserReducer.loading);
  const error = useSelector(state => state.recommendedUserReducer.error);

  useEffect(() => {
    dispatch(setLoadingRecommendedUsers(true));
